...
**Boardriders** — это интернет-магазин спортивных товаров.

Проект разработан на **React + TypeScript** с бэкендом на **Supabase**.

- Динамический каталог товаров с фильтрацией и сортировкой
- Авторизация и управление пользователем через Supabase
